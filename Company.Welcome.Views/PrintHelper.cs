...
namespace Company.Welcome.Business
{
    public class PrintHelper
    {
        ...
        public async Task ShowPrintUIAsync()
        {
            ...
            {
                MainPage.Current.NotifyUser("Error printing: " + e.Message + ", hr=" + e.HResult, MainPage.NotifyType.ErrorMessage);
            }
        }
            ...
            printTask = e.Request.CreatePrintTask("C# Printing SDK Sample", sourceRequested =>
            {
                ...
                printTask.Completed += async (s, args) =>
                {
                    ...
                    if (args.Completion == PrintTaskCompletion.Failed)
                    {
                        ...
                        {
                            MainPage.Current.NotifyUser("Failed to print.", MainPage.NotifyType.ErrorMessage);
                        });
                    }
                };
